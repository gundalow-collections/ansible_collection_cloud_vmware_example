...
extends_documentation_fragment: jctanner.cloud_vmware.vmware_rest_client.documentation
'''
...
from ansible_collections.jctanner.cloud_vmware.plugins.module_utils.vmware_rest_client import VmwareRestClient
from ansible_collections.jctanner.cloud_vmware.plugins.module_utils.vmware import PyVmomi
