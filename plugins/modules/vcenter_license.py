...
- If C(esxi_hostname) is specified, then will assign the C(license) key to
  the ESXi host.
extends_documentation_fragment: jctanner.cloud_vmware.vmware.vcenter_documentation
'''
...
from ansible_collections.jctanner.cloud_vmware.plugins.module_utils.vmware import PyVmomi, vmware_argument_spec, find_hostsystem_by_name
